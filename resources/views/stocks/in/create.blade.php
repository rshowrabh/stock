        ...
        <main class="py-2 w-50 border bg-white text-center">
            <form method="POST" action="{{ route('stocks-in.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input required value="{{ old('date') }}" name="date" type="date" class="form-control"
                        aria-describedby="nameHelp">
                    <label class="form-label">Qunatity</label>
                    <input required value="{{ old('quantity') }}" name="quantity" type="number" class="form-control"
                        aria-describedby="nameHelp">
                    <label class="form-label">Price</label>
                    <input required value="{{ old('price') }}" name="price" type="number" class="form-control"
                        aria-describedby="nameHelp">
                    <label class="form-label">Comment</label>
                    <input value="{{ old('comment') }}" name="comment" type="text" class="form-control"
                        aria-describedby="nameHelp">
